...
const femalePlayer = sequelizeFemale.define('players', {
    id: {
    ...
    value_eur: { type: DataTypes.INTEGER, allowNull: true },
    wage_eur: { type: DataTypes.INTEGER, allowNull: true },
    age: { type: DataTypes.INTEGER, allowNull: false },
    height_cm: { type: DataTypes.INTEGER, allowNull: true },
    weight_kg: { type: DataTypes.INTEGER, allowNull: true },
    preferred_foot: { type: DataTypes.STRING, allowNull: true },
    weak_foot: { type: DataTypes.INTEGER, allowNull: true },
    skill_moves: { type: DataTypes.INTEGER, allowNull: true },
    international_reputation: { type: DataTypes.INTEGER, allowNull: true },
    work_rate: { type: DataTypes.STRING, allowNull: true },
    body_type: { type: DataTypes.STRING, allowNull: true },
    ...
    player_traits: { type: DataTypes.STRING, allowNull: true }
}, {
    timestamps: false
});
